...
var RecursiveIterator__default = /*#__PURE__*/_interopDefaultLegacy(RecursiveIterator);
...
function selectFirstSpectrum(toc) {
  ...
  for (let { node } of new RecursiveIterator__default["default"](toc)) {
    if (node.file) {
      node.selected = true;
      return toc;
    }
